    ...
    $.jgrid.extend({
        ...
        editGridRow: function (rowid, p) {
            ...
            return this.each(function () {
                ...
                // buttons at footer
                var
                bP = "<a id='" + bp + "' class=''><span class=''></span></a>",
                bN = "<a id='" + bn + "' class=''><span class=''></span></a>",

                bS = "<a id='sData' class='btn btn-info pull-right'>Save</a>",
                bC = "<a id='cData' class='btn btn-default'>Cancel</a>";

                var bt = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + frmtborg + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'><div class='box-footer'>" + (rtlb ? bN + bP : bP + bN) + "</div> </td><td class='EditButton'>" + bS + bC + "</td></tr>";
